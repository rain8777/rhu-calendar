    ...
    <>
      ...
      <style jsx global>{`
        ...
        @media print {
          ...
          .sidebar, .sidebar-backdrop, .side-panel, .mob-header, .bottom-nav, .program-tabs-bar, .theme-row, .legend, .btn-today, .btn-refresh, .nav-arrow, .cal-header { display: none !important; }
